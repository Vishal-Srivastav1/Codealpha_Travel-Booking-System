...
<nav class="navbar navbar-expand-lg  bg-custom hello">
	<div class="container-fluid ">
		<img alt="" src="img/air-logo.png" class="eg2">
		...
		<c:if test="${ empty userobj }">
			<ul class="navbar-nav me-auto mb-2 mb-lg-0 " style="margin-left:50%; gap:10px;">
			
		</c:if>
		
		<c:if test="${userobj.role eq 'User'}">
			<ul class="navbar-nav me-auto mb-2 mb-lg-0 " style="margin-left:27%; gap:8px;">
			
		</c:if>
		
		<c:if test="${userobj.role eq 'admin'}">
			<ul class="navbar-nav me-auto mb-2 mb-lg-0 " style="margin-left:26%; gap:10px;">
